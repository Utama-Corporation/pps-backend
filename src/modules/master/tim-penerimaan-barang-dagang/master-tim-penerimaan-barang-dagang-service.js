// master-tim-penerimaan-barang-dagang-service.js
//
// CRUD tim penerimaan barang dagang — beroperasi di atas dbo.MstTimPenerimaan
// (tabel gabungan, kolom flag TipeModul) dengan filter TipeModul='BARANG_DAGANG'
// tetap, mirroring master-tim-penerimaan-bahan-pendukung-service.js, supaya
// tim modul lain (Bahan Baku, Bahan Pendukung) tidak ikut muncul/tertimpa
...
const TIPE_MODUL = "BARANG_DAGANG";
...
async function update(idTim, { namaTim, keterangan, aktif }) {
  ...
  if (!existing) {
    throw notFound("Data tim penerimaan barang dagang tidak ditemukan");
  }
