...
const ID_BAGIAN_MIXER = 5;

async function getMixerShiftHoursByDateAndShift({ tanggal, shift }) {
  const pool = await poolPromise;
  const request = pool.request();

  request.input("Tanggal", sql.Date, tanggal);
  request.input("NoShift", sql.Int, shift);
  request.input("IdBagian", sql.Int, ID_BAGIAN_MIXER);
...
async function getMixerCurrentShift() {
  const pool = await poolPromise;
  const request = pool.request();
...
async function getGilinganShiftHoursByDateAndShift({ tanggal, shift }) {
  const pool = await poolPromise;
  const request = pool.request();

  request.input("Tanggal", sql.Date, tanggal);
  request.input("NoShift", sql.Int, shift);
  request.input("IdBagian", sql.Int, ID_BAGIAN_GILINGAN);
...
async function getGilinganCurrentShift() {
  const pool = await poolPromise;
  const request = pool.request();
...
async function getInjectShiftHoursByDateAndShift({ tanggal, shift }) {
  const pool = await poolPromise;
  const request = pool.request();

  request.input("Tanggal", sql.Date, tanggal);
  request.input("NoShift", sql.Int, shift);
  request.input("IdBagian", sql.Int, ID_BAGIAN_INJECT);
...
async function getInjectCurrentShift() {
  const pool = await poolPromise;
  const request = pool.request();
...
module.exports = {
  getShiftHoursByDateAndShift,
  getMixerShiftHoursByDateAndShift,
  getCurrentShift,
  getMixerCurrentShift,
  getGilinganShiftHoursByDateAndShift,
  getGilinganCurrentShift,
  getInjectShiftHoursByDateAndShift,
