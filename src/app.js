...
const stockOpnameV2Routes = require("./modules/stock-opname-v2/stock-opname-v2-routes");
...
const mstMixerRoutes = require("./modules/master/mixer/master-mixer-route");
const mstFurnitureWipRoutes = require("./modules/master/furniture-wip/master-furniture-wip-route");
...
const labelBahanPendukungRoutes = require("./modules/label/bahan-pendukung/bahan-pendukung-routes");
const labelBarangDagangRoutes = require("./modules/label/barang-dagang/barang-dagang-routes");
...
const penerimaanBarangDagangRoutes = require("./modules/production/penerimaan-barang-dagang/penerimaan-barang-dagang-route");
...
const mstTimPenerimaanBahanPendukungRoutes = require("./modules/master/tim-penerimaan-bahan-pendukung/master-tim-penerimaan-bahan-pendukung-route");
const mstTimPenerimaanBarangDagangRoutes = require("./modules/master/tim-penerimaan-barang-dagang/master-tim-penerimaan-barang-dagang-route");
const mstBarangDagangRoutes = require("./modules/master-barang-dagang/master-barang-dagang-route");
...
app.use("/api/", stockOpnameV2Routes);
...
app.use("/api/mst-mixer", mstMixerRoutes);
app.use("/api/mst-furniture-wip", mstFurnitureWipRoutes);
...
app.use("/api/", labelBahanPendukungRoutes);
app.use("/api/", labelBarangDagangRoutes);
...
app.use("/api/mst", mstTimPenerimaanBarangDagangRoutes);
app.use("/api/mst-barang-dagang", mstBarangDagangRoutes);
...
app.use("/api/penerimaan-barang-dagang", penerimaanBarangDagangRoutes);
