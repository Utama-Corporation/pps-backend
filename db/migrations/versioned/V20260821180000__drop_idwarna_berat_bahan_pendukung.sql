-- ================================================================
-- Migration: Drop IdWarna and Berat from BahanPendukung
-- ================================================================
-- Kolom IdWarna dan Berat tidak valid/tidak digunakan.
-- ================================================================

-- 1. Drop IdWarna
IF EXISTS (SELECT 1 FROM sys.columns WHERE object_id = OBJECT_ID('dbo.BahanPendukung') AND name = 'IdWarna')
BEGIN
  ALTER TABLE [dbo].[BahanPendukung] DROP COLUMN [IdWarna];
END
GO

-- 2. Drop Berat
IF EXISTS (SELECT 1 FROM sys.columns WHERE object_id = OBJECT_ID('dbo.BahanPendukung') AND name = 'Berat')
BEGIN
  ALTER TABLE [dbo].[BahanPendukung] DROP COLUMN [Berat];
END
GO

-- 3. Recreate audit trigger
